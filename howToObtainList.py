# To obtain the list for image that is inside the folder 'PutTheImageHere'
# just write the code bellow


from simpleScorbotCoords import *
...
height = 2970 #check with teacher if this size is ok

# Put the coords (in tenths of milimiters) of the top left corner of the paper (like you are facing towards the front of the robot)
startingPointScorbot = [6000, -3000] #check with teacher if this size is ok

# Run Main code
_, _, rdpStepsList = getSimpleCoords(radiusStep, epsilon, height, startingPointScorbot, showPrints=True)
